...
public class UserRollcall2Adapter extends RecyclerView.Adapter<UserRollcall2Adapter.ViewHolder> {
    private Context mContext;
    private ArrayList<String> mUsers;
    String Url = "https://catch-763a4-default-rtdb.asia-southeast1.firebasedatabase.app/";

    public UserRollcall2Adapter(Context mContext, ArrayList<String> mUsers) {
        this.mUsers = mUsers;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        //載入圖片
        holder.profile_image.setImageResource(R.drawable.positive_vote);
        //載入名子
        holder.username.setText(mUsers.get(position));
        //載入點名紀錄
        holder.rollcalltime.setText("已簽到");
        //備用方案
