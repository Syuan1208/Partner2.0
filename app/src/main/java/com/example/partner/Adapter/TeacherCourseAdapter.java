...
public class TeacherCourseAdapter extends FragmentStateAdapter {
    public TeacherCourseAdapter(@NonNull FragmentManager fragmentManager, @NonNull Lifecycle lifecycle) {
