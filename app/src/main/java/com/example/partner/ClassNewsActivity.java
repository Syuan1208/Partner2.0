...
public class ClassNewsActivity extends AppCompatActivity {
...
//    TextView username;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //finish();
                startActivity(new Intent(ClassNewsActivity.this, TeacherActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
        firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        //滾動頁面
        viewPager2 =findViewById(R.id.view_paper);
        ClassNewsAdapter classNewsAdapter=new ClassNewsAdapter(getSupportFragmentManager(),getLifecycle());
        viewPager2.setAdapter(classNewsAdapter);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_teacher_rollcall:
                        ...
                        break;
                    case R.id.navigation_teacher_group:
                        item.setChecked(true);
                        ...
                        break;
                    case R.id.navigation_teacher_test:
                        item.setChecked(true);
    ...
    public String getclassrollcall() {
        Intent intent;
        intent = getIntent();
        return intent.getStringExtra("classrollcall");
    }
    public ArrayList<String> getstudentlist() {
        Intent intent;
        intent = getIntent();
        return intent.getStringArrayListExtra("studentlist");
    }
    public ArrayList<String> getalluserrollcall() {
        Intent intent;
        intent = getIntent();
        return intent.getStringArrayListExtra("alluserrollcall");
    }
